...
export default function Dropdown() {
  ...
  return (
    <div className={`${inter.className} text-white text-lg w-[12rem]`}>
      <div className='flex bg-gradient-to-r from-[#1E0786] to-[#4129F8] w-[12rem] py-3 px-6 rounded-lg justify-end items-center hover:cursor-pointer' onClick={handleSelectClick}>
      ...
      {collapsed && (
        <div className='mt-1 absolute grow bg-gradient-to-r w-[12rem] from-[#1E0786] to-[#4129F8] rounded-lg flex flex-col items-center justify-between text-center p-5 max-h-[10rem] overflow-scroll'>
