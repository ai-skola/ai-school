...
export default function Menu() {
  return (
    <div className='h-[calc(100% - 1rem)] flex flex-col justify-between items-center py-8 px-4 my-4 mx-2 bg-[#FEFEFE] border-2 border-customblue-50 rounded-3xl shadow'>
